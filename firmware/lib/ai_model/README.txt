...
# Edge Impulse library for ESP32-UWB-Collision-Classifier

This is a C++ library that lets you run the impulse for "ESP32-UWB-Collision-Classifier" (https://studio.edgeimpulse.com/studio/1113007) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
